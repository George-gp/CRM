...
//新建
  $('.layui-icon-upload-circle').on('click', function(){
    layer.open({
      ...
      content: ` <form id="atvFrom2" action="customer/addActivities" method="post">
      <div class="layui-form-item">
      <input type="hidden" name="atv_cust_id" value="${cust_id}" >
...
//编辑
  $('.layui-icon-edit').on('click', function(){
    ...
    layer.open({
      ...
      shadeClose: true, //点击遮罩关闭
      content: `
   <form id="atvFrom1" action="customer/updateActivity" method="post">        
...
//删除
   $('.layui-icon-delete').on('click', function(){
	   var atv_id = $(this).attr('value'); 
        	 ...
        	 $('.layui-body').load('customer/deleteOneActivity?atv_id='+atv_id);
