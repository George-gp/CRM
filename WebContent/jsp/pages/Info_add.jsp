...
<body>
 ...
 <div class="listOne">
    ...
    <form id="addCustomer" action="customer/Info_add" method="post">
  ...
  <div class="layui-form-item">
   ...
   <label class="layui-form-label">客户网址</label>
    ...
    <div class="layui-input-block">
      <input type="text" name="cust_chieftain" style="width:1000px"  placeholder="请输入企业法人名称" autocomplete="off" class="layui-input">
    </div>
    ...
    <div class="layui-input-block">
      <input type="text" name="cust_national_tax_no" style="width:1000px"  placeholder="请输入国税登记号" autocomplete="off" class="layui-input">
    </div>
