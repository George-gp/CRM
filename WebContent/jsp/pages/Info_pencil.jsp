...
layui.use('laypage', function(){
  ...
  $('.layui-icon-note').on('click', function(){
    layer.open({
      ...
      content: `<form id="addForm1" action="customer/addLinkman" method="post" >
    ...
    var	lkm_cust_id = $(this).attr('value');
 	$('#hidden4').attr('value',lkm_cust_id);
  ...
  $('.layui-icon-file-b').on('click', function(){
    ...
    layer.open({
      ...
      area: ['600px', '200px'],
      shadeClose: true, //点击遮罩关闭
      content:`<form id="editForm1" action="customer/updateLinkman" method="post" >
      <div class="layui-form-item">
...
//删除
  $('.layui-icon-delete').on('click', function(){
	  var lkm_id = $(this).attr('value');
        	 ...
        	 $('.layui-body').load("customer/deleteLinkMan?lkm_id="+lkm_id);
