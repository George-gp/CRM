...
<script>
  ...
  var laypage = layui.laypage;
    ...
    layer.open({
      ...
      <form id="custForm" action="customer/changeCust" method="post">
   ...
   <div class="layui-form-item">
    ...
    var	cust_id = $(this).attr('value');
 	$('#hidden1').attr('value',cust_id);
            ...
            $(document).ready(function()
      {
        ...
        {
        	var	cust_id = $(this).attr('value');
	           $('.layui-body').load("customer/findLinkman?cust_id="+cust_id);
        })
      });
           $(document).ready(function()
      {
        ...
        {
        	 var cust_id = $(this).attr('value');
           $('.layui-body').load("customer/findAllActivity?cust_id="+cust_id);
        })
      })
    ...
    $('.layui-icon-delete').on('click', function(){
    	...
    	cust_id1 = $(this).attr('value');
        	...
        	$('.layui-body').load("customer/deletecust?cust_id="+cust_id1); 
